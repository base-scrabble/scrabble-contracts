...
//         console.log("Handler initialized with Scrabble at", address(scrabble), "and Wallet at", address(wallet));
//     }
...
//         vm.prank(player);
//         console.log("Depositing", amount, "ETH for player", player);
//         wallet.depositETH{value: amount}(sig);
//         console.log("Deposited", amount, "ETH for player", player, "Balance:", wallet.getBalance(player, address(0)));
//     }
...
//         bytes memory sig = signAuth(player);
//         vm.prank(player);
//         console.log("Creating game with stake", stake, "by player", player);
//         scrabble.createGame(stake, address(0), sig);
//         console.log("Game created with ID", scrabble.GameId(), "by player", player);
//     }
...
//         bytes memory sig = signAuth(player);
//         vm.prank(player);
//         console.log("Player", player, "attempting to join game ID", gameId, "with stake", stake);
//         try scrabble.joinGame(gameId, stake, sig) {
//             console.log("Player", player, "joined game ID", gameId);
//         } catch {
//             console.log("Failed to join game ID", gameId, "for player", player);
//         }
//     }
...
//             console.log("Score for player", game.players[i], "set to", scores[i]);
//         }
//         vm.prank(submitter);
//         console.log("Submitting result for game ID", gameId, "with winner", winner);
//         try scrabble.submitResult(gameId, winner, bytes32(0), scores, scrabble.getGame(gameId).scores.length) {
//             console.log("Result submitted for game ID", gameId);
//         } catch {
//             console.log("Failed to submit result for game ID", gameId);
//         }
//     }
...
//             console.log("Checking balances for player", players[i], "ETH:", ethBalance, "USDT:", usdtBalance, "USDC:", usdcBalance);
